%pr23
% PARA MET ADAPTATIVOS (METADAP Y RKF45)
...
% metodo adaptativo
%TOL=10^(-5); hmin=10^(-7);[t1,u1]=mirkf45(tini,tfin,N,hmin,TOL,x0,fun,par);
TOL=10^(-3);hmin=10^(-5);met=@mieuler; [t1,u1]=mimetadap(tini,tfin,N,hmin,x0,fun,par,met,1,TOL);
